...
from Database import User, EventType, WorldExplorers
...
class WorldExplorersCog(commands.Cog, name='World Explorers Commands'):
    ...
    async def catan_group(self, ctx):
        pass
...
def setup(bot):
    bot.add_cog(WorldExplorersCog(bot))
